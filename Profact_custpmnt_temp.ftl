...
<cfdi:Comprobante xmlns:pago20="http://www.sat.gob.mx/Pagos20"  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cfdi="http://www.sat.gob.mx/cfd/4" xsi:schemaLocation="http://www.sat.gob.mx/cfd/4 http://www.sat.gob.mx/sitio_internet/cfd/4/cfdv40.xsd http://www.sat.gob.mx/Pagos20 http://www.sat.gob.mx/sitio_internet/cfd/Pagos/Pagos20.xsd"
    ...
    <#if customer.custentity_mx_rfc == "XAXX010101000" || customer.custentity_mx_rfc == "XEXX010101000" || customer.custentity_mx_rfc == "" || transaction.custbody_efx_fe_factoraje_rfc == "XEXX010101000" ||  transaction.custbody_efx_fe_factoraje_rfc == "XAXX010101000">
        ...
        <pago20:Pagos Version="2.0">
            ...
            >
                ...
                <#if transaction.custbody_efx_fe_id_facturaglobal?has_content>
                         <pago20:DoctoRelacionado IdDocumento="${FGlobal.uuid}"  Folio="${FGlobal.folio}" Serie="${FGlobal.serie}" MonedaDR="${FGlobal.currency}" EquivalenciaDR="${FGlobal.exchangerate}" NumParcialidad="${CalculoParcialidad}" ImpSaldoAnt="${FGlobal.total}" ImpPagado="${FGlobal.total}" ImpSaldoInsoluto="0" ObjetoImpDR="${objetoimpDR}">
