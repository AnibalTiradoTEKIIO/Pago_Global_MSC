...
<cfdi:Comprobante xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cfdi="http://www.sat.gob.mx/cfd/4" xmlns:pago20="http://www.sat.gob.mx/Pagos20" xsi:schemaLocation="http://www.sat.gob.mx/cfd/4 http://www.sat.gob.mx/sitio_internet/cfd/4/cfdv40.xsd http://www.sat.gob.mx/Pagos20 http://www.sat.gob.mx/sitio_internet/cfd/Pagos/Pagos20.xsd"
        ...
        <pago20:Pagos Version="2.0">
            ...
            <#if esTrasladoIva==true>
                ...
                <#if totaltrasladosiva0base gt 0>
                    <#if transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">TotalTrasladosBaseIVA0="${(totaltrasladosiva0div)?string("##0.00;; roundingMode=down")}"<#elseif currencyCode==transaction.custbody_efx_fe_moneda.symbol>TotalTrasladosBaseIVA0="${(totaltrasladosiva0base*transaction.exchangerate)?string["0.00"]}"<#else>TotalTrasladosBaseIVA0="${totaltrasladosiva0base?string["0.00"]}"</#if>
            ...
            >
                ...
                <#assign contador = 0>
                      <#if transaction.custbody_efx_fe_id_facturaglobal?has_content>
                    <#list custom.appliedTxns as appliedTxn>
                    <#if contador==0>
                        ...
                        <#if jsonImpuestoVar?has_content>
                          <#if impuestosPago.bases_iva?has_content || impuestosPago.bases_ieps?has_content || impuestosPago.bases_retencion?has_content>
                            ...
                            <pago20:DoctoRelacionado IdDocumento="${FGlobal.uuid}"  Folio="${FGlobal.folio}" Serie="${FGlobal.serie}" MonedaDR="${FGlobal.currency}" EquivalenciaDR="${FGlobal.exchangerate}" NumParcialidad="1" ImpSaldoAnt="${FGlobal.total}" ImpPagado="${FGlobal.total}" ImpSaldoInsoluto="0" ObjetoImpDR="${objetoimpDR}">
                        ...
                        <#if jsonImpuestoVar?has_content>
                                ...
                                <#list ImpuestosPTraslados_base as baseTkey, baseTvalue>
                                    ...
                                    <#if desglosa_ieps == true>
                                        <#if impuestoPType=="003">
                                            <pago20:TrasladoDR BaseDR="${basePmonto?string["0.00"]}" ImpuestoDR="${impuestoPType}" TipoFactorPDR="Tasa" TasaOCuotaDR="${tasaCuota?string["0.000000"]}" <#if ImportePIVA16?number gte 0 && tasaCuota?string["0.000000"] == "0.160000">ImporteDR="${ImportePIVA16}"<#elseif ImportePIVA8?number gt 0 && tasaCuota?string["0.000000"] == "0.080000">ImporteDR="${ImportePIVA8}"<#elseif totaltrasladosieps53?number gt 0 && tasaCuota?string["0.000000"] == "0.530000">ImporteDR="${totaltrasladosieps53}"<#elseif totaltrasladosieps265?number gt 0 && tasaCuota?string["0.000000"] == "0.265000">ImporteDR="${totaltrasladosieps265}"<#elseif totaltrasladosieps8?number gt 0 && tasaCuota?string["0.000000"] == "0.080000">ImporteDR="${totaltrasladosieps8}"<#else><#if transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">ImporteDR="${(((ImpuestosPTraslados_importe[baseTkey]?string["0.00"])?number*tasaCuota?number)/tipocambioCustom)?string["0.00"]}"<#else>ImporteDR="${(((ImpuestosPTraslados_importe[baseTkey]?string["0.00"])?number*tasaCuota?number)/tipocambioCustom)?string["0.00"]}"</#if></#if>/>
                                        </#if>
                                        <#if impuestoPType!="003">
                                            <#if transaction.custbody_efx_fe_moneda?has_content == false && transaction.currencysymbol == "EUR">
                                                <pago20:TrasladoDR BaseDR="${basePmonto?string['0.00']}" ImpuestoDR="${impuestoPType}" TipoFactorDR="Tasa" TasaOCuotaDR="${tasaCuota?string['0.000000']}" ImporteDR="${(((ImpuestosPTraslados_importe[baseTkey]?string['0.00'])?number*tasaCuota?number)/tipocambioCustom)?string['0.00']}"/>
                                            <#else>
                                                <pago20:TrasladoDR BaseDR="${basePmonto?string["0.00"]}" ImpuestoDR="${impuestoPType}" TipoFactorDR="Tasa" TasaOCuotaDR="${tasaCuota?string["0.000000"]}" <#if ImportePIVA16?number gte 0 && tasaCuota?string["0.000000"] == "0.160000">ImporteDR="${ImportePIVA16}"<#elseif ImportePIVA8?number gt 0 && tasaCuota?string["0.000000"] == "0.080000">ImporteDR="${ImportePIVA8}"<#else><#if transaction.custbody_efx_fe_moneda.symbol == "MXN" && transaction.currencysymbol == "USD">ImporteDR="${(((ImpuestosPTraslados_importe[baseTkey]?string["0.00"])?number*tasaCuota?number)/tipocambioCustom)?string["0.00"]}"<#else>ImporteDR="${(((ImpuestosPTraslados_importe[baseTkey]?string["0.00"])?number*tasaCuota?number)/tipocambioCustom)?string["0.00"]}"</#if></#if>/>
                                            </#if>
                                        </#if>
                                    <#else>
                            ...
                            <pago20:RetencionesDR>
                                <#list ImpuestosPRetencion_base as baseRkey, baseRvalue>
                                    ...
                                    <pago20:RetencionDR ImpuestoP="${impuestoPType}" ImporteP="${ImpuestosPRetencion_importe[baseRkey]?string["0.00"]}"/>
                                </#list>
                            </pago20:RetencionesDR>
                            </#if>
